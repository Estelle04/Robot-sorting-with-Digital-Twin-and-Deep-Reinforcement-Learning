...
public class ReacherReward : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (!agent.GetComponent<ReacherRobot>().IsGreenGoalAtDroppoint)
            {
        ...
        {
            if (!agent.GetComponent<ReacherRobot>().IsRedGoalAtDroppoint)
            {
